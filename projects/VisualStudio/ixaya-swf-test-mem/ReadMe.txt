========================================================================
    APLICACIÓN DE CONSOLA: ixaya-swf-test-mem 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ixaya-swf-test-mem.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación ixaya-swf-test-mem.


ixaya-swf-test-mem.vcxproj
...
ixaya-swf-test-mem.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado ixaya-swf-test-mem.pch y un archivo de tipos 
