========================================================================
    APLICACIÓN DE CONSOLA: ixaya-swf-demo-read 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ixaya-swf-demo-read.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación ixaya-swf-demo-read.


ixaya-swf-demo-read.vcxproj
...
ixaya-swf-demo-read.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado ixaya-swf-demo-read.pch y un archivo de tipos 
